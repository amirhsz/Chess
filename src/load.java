...
public class load extends javax.swing.JFrame {
    ...
    String name;
    App loaded;
    File dir = new File("F:\\java\\Chess\\saved");
    public load(startframe c) {
        a=c;
        if(chose){
            loaded = new App(this);
        }
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            choser = new FileReader("F:\\java\\Chess\\saved\\"+name);
        } catch (Exception ex) {}
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        DefaultComboBoxModel a = new DefaultComboBoxModel(dir.list());
        this.jComboBox1.setModel(a);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new load(new startframe()).setVisible(true);
            }
        });
    }
